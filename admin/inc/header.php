...
<head>
	...
	<link rel="stylesheet" href="/public/editor/css/samples.css">
	<link rel="stylesheet" href="/public/editor/toolbarconfigurator/lib/codemirror/neo.css">
...
<body id="page-top">
    ...
    <div id="wrapper">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="categorylist.php">List Category</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
        ...
        <div id="collapsePayment" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="brandadd.php">Add Brand</a>
                        <a class="collapse-item" href="brandedit.php">Edit Brand</a>
                        <a class="collapse-item" href="brandlist.php">List Brand</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapseStatistic" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="productadd.php">Add Brand</a>
                         <a class="collapse-item" href="productedit.php">Edit Brand</a>
                        <a class="collapse-item" href="productlist.php">List Brand</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Danh mục quản lý Blogs</h6>
               
                <a class="collapse-item" href="Blogadd.php">Add Blogs</a>
                         <a class="collapse-item" href="Blogedit.php">Edit Blogs</a>
                        <a class="collapse-item" href="Bloglist.php">List Blogs</a>
    ...
    <li class="nav-item">
        ...
        <div id="collapse" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Danh mục quản lý Oder</h6>
               
                <a class="collapse-item" href="odermanament.php">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            ?>
                                <a href="?action=logout" class="dropdown-item">Logout</a>

                     ...
                     <br>
                        ...
                        <div class="form-group">
                           ...
                           ?>></option>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-group pb-6">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">CHẤT LIỆU MẶT KÍNH</span>
                                                    <span>  
                                                        <select class="input-group pb-3" required name="type1" data-toggle="movie-dropdown" oninvalid="this.setCustomValidity('Có phải bạn có quên chọn gì đó?')" onchange="this.setCustomValidity('')">
                                                            <option value="" data-display="Thể Loại">Chưa chọn...</option>
                            ...
                            if($result_product['type']==0){
                            ?>
                            <option selected value="0"> Đá</option>
                            <option value="1">Nhựa</option>
                            <?php
                        }else{
                            ?>
                            <option value="0"> Đá</option>
                            <option selected value="1">Nhựa</option>
                            <?php
                            }
                            ?>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-group pb-6">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">CHẤT LIỆU DÂY</span>
                                                    <span>  
                                                        <select class="input-group pb-3" required name="type2" data-toggle="movie-dropdown" oninvalid="this.setCustomValidity('Có phải bạn có quên chọn gì đó?')" onchange="this.setCustomValidity('')">
                                                            <option value="" data-display="Thể Loại">Chưa chọn...</option>
                            ...
                            if($result_product['type']==0){
                            ?>
                            <option selected value="0">Dây Da</option>
                            <option value="1">Dây Kim Loại</option>
                            <?php
                        }else{
                            ?>
                            <option value="0">Dây Da</option>
                            <option selected value="1">Dây Kim Loại</option>
                            <?php
                            }
                            ?>

                    		...
                    		?>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text"type="text" name="name" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder=" Name">
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="zipcode" class="form-control form-control-user" id="exampleLastName"
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input  type="text" name="city" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder=" CiTy">
                                    </div>
                                    <div class="col-sm-6" >
                                ...
                                <select  id="country" name="country" class="form-control" id="sel1" style=";browser-default custom-select custom-select-lg mb-3">
